...
const MyOrder = () => {
    ...
    const handleProductPayment = (productID) => {
                            ...
                            <div className="modal">
                                <div className="modal-box">
                                    ...
                                    <div className="p-6 text-center">
                                        ...
                                        <button onClick={() => handleProductPayment(productDetails._id)} htmlFor="productdeleteConferm-modal" data-modal-toggle="popup-modal" type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                            Yes, I'm sure
                                        </button>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <th>
                                                ...
                                                <label onClick={() => setPeoductDetails(product)} htmlFor="productdeleteConferm-modal" className="btn btn-error btn-xs text-white ml-2">UnBooked</label>
                                            </th>
                                        </th>
                                    </tr>
                                </>
