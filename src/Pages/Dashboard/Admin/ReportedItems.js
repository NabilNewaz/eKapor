    ...
    const handleAdvertiseData = (productID) => {
        axios.patch(`https://b612-used-products-resale-server-side-nabil-newaz.vercel.app/product-reported/${productID}`, {
            ...
            .then(function () {
                refetch();
                closeAdvertiseModal();
                toast.success(`Product Report Remove`)
            })
            .catch(function () {
                toast.error('Something Went Wrong')
            });
            ...
            <div className='pt-2 px-2'>
                ...
                <div className="overflow-x-auto w-full">
                    <table className="table w-full">
                        ...
                        <div>
                            ...
                            <div className="modal">
                                <div className="modal-box">
                                    ...
                                    <div className="p-6 text-center">
                                        <svg aria-hidden="true" className="mx-auto mb-4 w-14 h-14 text-gray-400 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to remove report?</h3>
                        ...
                        <tbody>
                            <tr className={(reportedproducts.length <= 0) ? '' : 'hidden'}>
                                <th colSpan="9" className='py-10'>
                            ...
                            {reportedproducts.map((product, index) =>
                                <>
                                    <tr>
                                        ...
                                        <td className='whitespace-normal'>{product.product_description}</td>
                                        <th>
                                            <th>
                                                <label onClick={() => setPeoductDetails(product)} htmlFor="productadvertiseConferm-modal" className='btn badge-warning btn-xs text-white'>Remove Report</label>
