                        ...
                        {allBuyers.map((buyer, index) =>
                            <>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <label htmlFor="sellerdeleteConferm-modal" className="btn btn-error btn-xs text-white">Delete</label>
                                    </th>
                                </tr>
                            </>
                        )}
